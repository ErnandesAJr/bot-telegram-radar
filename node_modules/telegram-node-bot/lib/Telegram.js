...
class Telegram {
    ...
    constructor(token, options) {
        ...
        this._webAdminPort = options.webAdmin ? options.webAdmin.port : 443// mudar onde vai ser a porta
        this._webAdminHost = options.webAdmin ? options.webAdmin.host : 'localhost' // mudar o ip

        this._cpus = os.cpus()
        this._workersCount = options.workers || this._cpus.length // Quantidade de trabalhadores
